...
class Pokemon(models.Model):
    ...
    description = models.TextField('Описание покемона', blank=True, default='Нет доступного описания.')
    image = models.ImageField('Изображение покемона', upload_to='pokemons', null=True, blank=True)
